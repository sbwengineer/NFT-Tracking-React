    ...
    return(
            <div className="header">
                <div className="header_text">
                    <p><b>You are not subscribed. </b>Take better services and snipe more effectively at our</p>
                    
                </div>
                <span className="header_space"/>
                <div className="header_action">
                    <Button className="header_btn" variant="contained" startIcon={<DiscordIcon font-size="small"/>} size="small">
                        Discord
                    </Button>
                    <span className="header_space"/>
                    <p>or</p>
                    <span className="header_space"/>
                    <Button className="header_btn" variant="contained" startIcon={<BuySubscriptionIcon font-size="small"/>} size="small">
                        BuySubscription
                    </Button>
                </div>
            </div>
